...
import { Printer, Download, Share2, X, CheckCircle, FileCode, Mail, Zap, RefreshCw, Scissors } from 'lucide-react';
      ...
      <div className="relative w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-6 hidden lg:block">
           <div className="flex items-center gap-4 text-emerald-500">
              ...
              <h3 className="font-space text-3xl font-bold uppercase tracking-tighter text-white">EMISIÓN COMPLETADA</h3>
           </div>
           ...
           <div className="grid grid-cols-1 gap-4">
              <div className="p-6 glass rounded-3xl border-emerald-500/20 bg-emerald-500/5 space-y-4">
                 <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-white uppercase tracking-widest">Protocolo UBL 2.1 Sunat</span>
                 </div>
                 <div className="flex flex-col gap-2">
                    <p className="text-[9px] font-mono text-slate-400 break-all leading-tight">CPE_HASH: {order.billing.hashCPE || 'GENERANDO...'}</p>
              ...
              <div className="p-6 glass rounded-3xl border-blue-500/20 bg-blue-500/5 space-y-4">
                 <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-white uppercase tracking-widest">Enterprise Notifier</span>
                 </div>
           ...
           <div className="p-6 glass rounded-3xl border-white/5 space-y-4">
              <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Hardware Info</p>
        ...
        <div className="relative w-full max-w-md mx-auto">
           <div className="w-full flex justify-end mb-4 no-print">
              <button onClick={onClose} className="p-3 glass rounded-2xl text-white hover:text-red-500 transition-all"><X /></button>
           </div>

           <div className={`w-full bg-[#f8f8f8] p-10 md:p-12 shadow-[0_40px_80px_rgba(0,0,0,0.6)] rounded-sm overflow-hidden relative transition-transform duration-700 ${paperCut ? 'translate-y-8' : ''}`}>
           ...
           <div className="flex gap-4 w-full mt-10 no-print">
              ...
              >
                 {printing ? <RefreshCw className="animate-spin w-4 h-4" /> : <Printer className="w-4 h-4 group-hover:scale-110" />}
