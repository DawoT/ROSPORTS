    ...
    <div className='fixed inset-0 z-[2000] flex items-center justify-center bg-main transition-colors duration-500'>
      ...
      <div className='relative w-full max-w-xl p-12 text-center space-y-12 animate-in zoom-in-95'>
        <div className='relative mx-auto w-32 h-32'>
          <div
            className='absolute inset-0 border-2 border-blue-500/20 rounded-[2.5rem] animate-spin'
            style={{ animationDuration: '10s' }}
          />
          <div
            className='absolute inset-2 border border-blue-500/10 rounded-[2rem] animate-reverse-spin'
        ...
        <div className='space-y-4'>
          <h2 className='text-[10px] font-black text-blue-500 uppercase tracking-[0.5em]'>
            Terminal de Seguridad ROSPORTS
          </h2>
          <h3 className='text-4xl font-space font-bold text-content-primary uppercase tracking-tighter leading-none'>
            TERMINAL <span className='text-red-500'>BLOQUEADO</span>
          </h3>
        ...
        <div className='pt-8 border-t border-content-muted/10 flex flex-col items-center gap-6'>
          <button
            ...
            className='text-[10px] font-black text-content-muted hover:text-red-500 uppercase tracking-widest flex items-center gap-3 transition-colors outline-none focus-visible:text-red-500'
          >
          ...
          <div className='flex items-center gap-4 opacity-20 grayscale'>
            ...
            <span className='text-[8px] font-black text-content-primary uppercase tracking-widest'>
