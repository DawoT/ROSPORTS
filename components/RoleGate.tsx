      ...
      fallback || (
        <div className='p-12 glass-card rounded-[3rem] border-red-500/20 bg-red-500/5 text-center space-y-6'>
          ...
          <div className='space-y-2'>
            <h3 className='text-xl font-space font-bold text-content-primary uppercase tracking-tight'>
              Acceso Restringido
            </h3>
            <p className='text-[10px] font-black text-content-muted uppercase tracking-widest'>
              Se requiere autorización de Nivel: {allowedRoles.join(', ').toUpperCase()}
            </p>
          </div>
        </div>
      )
