          ...
          <div className='flex items-center gap-3 text-emerald-500'>
            ...
            <div className='flex flex-col'>
              ...
              <h2 className='font-space text-4xl font-bold dark:text-white uppercase tracking-tighter'>
                Supply <span className='text-emerald-500'>Chain</span>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div className='lg:col-span-3 space-y-8'>
          <div className='glass p-6 rounded-[2.5rem] border-white/5 flex gap-4'>
            <div className='flex-1 relative'>
              ...
              <input
                type='text'
                placeholder='BUSCAR PO POR ID, PROVEEDOR O PRODUCTO...'
                className='w-full pl-14 pr-8 py-5 bg-black/40 rounded-2xl outline-none text-xs font-bold text-white uppercase tracking-widest border border-white/5 focus:border-emerald-500/50'
                value={query}
                  ...
                  <tr key={o.id} className='hover:bg-white/[0.02] transition-colors group'>
                    <td className='px-8 py-6'>
                      <div className='flex flex-col'>
                        ...
                        <span className='text-[9px] font-mono text-emerald-500 tracking-tighter'>
                          PROTOCOLO_INBOUND_X2
                        </span>
                      </div>
                    </td>
        ...
        <aside className='space-y-8'>
          <div className='glass-card rounded-[3rem] p-10 border-white/5 space-y-8 bg-gradient-to-br from-emerald-500/[0.03] to-transparent'>
            ...
            <div className='pt-6 border-t border-white/5 text-center'>
              <p className='text-[9px] text-slate-500 uppercase tracking-[0.2em] animate-pulse'>
                Synchronizing Global Hub...
              </p>
            </div>
          </div>
