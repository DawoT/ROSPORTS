...
import { ShoppingCart, ChevronRight, Zap, ShieldCheck, Globe, Activity, Star, Target } from 'lucide-react';
        ...
        <div className="flex flex-col gap-10 animate-in slide-in-from-left-12 duration-1000">
          ...
          <div className="space-y-4">
            ...
            <p className="text-content-secondary text-lg lg:text-2xl max-w-xl leading-relaxed font-medium">
              Zapatillas de alto desempeño. Ingeniería aplicada a la cultura urbana, disponible exclusivamente para la red ROSPORTS.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-6">
            ...
            <div className="flex items-center gap-6 px-8 py-5 glass rounded-[2.5rem] enterprise-border">
               <div className="flex -space-x-4">
                  {[1,2,3].map(i => (
                    <div key={i} className="w-12 h-12 rounded-full border-4 border-main bg-surface flex items-center justify-center shadow-xl">
                       <Star className="w-4 h-4 text-amber-500 fill-current" />
                    </div>
                  ))}
               </div>
               <div>
                  <p className="text-content-primary text-[10px] font-black uppercase tracking-widest leading-none">Certificado</p>
                  <p className="text-content-muted text-[8px] font-bold uppercase tracking-widest mt-1">100% Original</p>
               </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-12 mt-16 py-12 border-t border-content-muted/10 w-full opacity-60">
            {[
              ...
              <div key={idx} className="space-y-3 group cursor-default">
                ...
                <p className="text-content-muted text-[9px] font-black uppercase tracking-widest">{item.label}</p>
        ...
        <div className="relative group animate-in zoom-in-95 duration-1000 hidden lg:block">
          ...
          <div className="absolute -top-10 -right-5 z-20 p-6 glass rounded-[2.5rem] enterprise-border animate-float shadow-2xl">
             <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-[10px] font-black text-brand-blue uppercase tracking-widest">STATUS: IN_STOCK</span>
          ...
          <div className="relative p-12 lg:p-24 glass rounded-[5rem] enterprise-border overflow-hidden group shadow-[0_100px_100px_rgba(0,0,0,0.2)] bg-surface/30">
             ...
             <div className="absolute bottom-0 left-0 w-full p-16 bg-gradient-to-t from-main/80 to-transparent flex justify-between items-end">
                <div className="space-y-2">
                   <h4 className="text-4xl font-space font-bold text-content-primary uppercase tracking-tighter">AIR MAX ELITE</h4>
                   <div className="flex items-center gap-4">
                      <p className="text-xs font-black text-brand-blue uppercase tracking-[0.4em]">Desde S/ 489.90</p>
                      <span className="px-3 py-1 bg-brand-offer/10 text-brand-offer text-[9px] font-black rounded-lg border border-brand-offer/20 uppercase">-25% EXCLUSIVE</span>
                   </div>
                </div>
                <button onClick={onShopClick} className="w-20 h-20 bg-brand-blue text-white rounded-[2rem] flex items-center justify-center hover:scale-110 transition-all shadow-2xl shadow-blue-500/40 group/btn">
