      ...
      fallback || (
        <div className='p-16 glass-card rounded-[3.5rem] border-red-500/20 bg-surface text-center space-y-10 animate-in zoom-in-95 shadow-2xl relative overflow-hidden'>
          ...
          <div className='relative mx-auto w-24 h-24'>
            <div
              className='absolute inset-0 border-2 border-red-500/20 rounded-[2rem] animate-spin'
          ...
          <div className='space-y-4 relative z-10'>
            <div className='flex items-center justify-center gap-3 text-red-600'>
              ...
              <h3 className='text-2xl font-space font-bold uppercase tracking-tighter'>
            ...
            <p className='text-[10px] font-black text-content-muted uppercase tracking-[0.4em] max-w-sm mx-auto leading-relaxed'>
              Tu credencial actual no cuenta con privilegios de nivel{' '}
              <span className='text-content-primary'>{allowedRoles.join(' / ').toUpperCase()}</span>
              .
            </p>
          </div>
          ...
          <div className='pt-8 border-t border-content-muted/10 flex flex-col items-center gap-6'>
            <div className='flex items-center gap-3 px-6 py-3 glass rounded-full border-content-muted/20'>
              ...
              <span className='text-[9px] font-black text-content-muted uppercase tracking-widest'>
                Protocolo de Identidad Rosports
              </span>
            </div>
            <button className='text-[10px] font-black text-brand-blue uppercase border-b border-brand-blue/30 pb-0.5 hover:text-brand-blue/70 transition-all'>
