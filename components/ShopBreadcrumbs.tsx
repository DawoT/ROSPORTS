...
const ShopBreadcrumbs: React.FC<BreadcrumbsProps> = ({ path, onNavigate }) => {
  return (
    <nav className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.2em] mb-12 animate-in slide-in-from-left-4 duration-700" aria-label="Navegación secundaria">
      <button 
