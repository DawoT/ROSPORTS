...
## Risks Accepted
*   **Strict Linting:** We enabled strict rules knowing it would break the lint check until full cleanup is done. This prevents *new* debt but highlights existing debt.
