...
export const FiscalEngine = {
  ...
  triggerPhysicalPrint: (order: OrderHistoryItem) => {
    ...
    console.log("%c[HARDWARE] OPENING CASH DRAWER (DRAWER_KICK CMD SENT)", "color: #10b981; font-weight: bold;");
    console.log("%c[HARDWARE] SENDING THERMAL STREAM TO PORT 9100", "color: #3b82f6; font-weight: bold;");
