...
export const ROSPORTS_TOOLS: FunctionDeclaration[] = [
  {
    ...
    parameters: {
      type: Type.OBJECT,
      description:
        'Verifica la disponibilidad exacta de un producto en un nodo logístico específico.',
      properties: {
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        reason: {
          type: Type.STRING,
          description: 'Motivo del cupón (ej: stock_bajo, consulta_tecnica).',
        },
  ...
  diagnoseProductFault: async (base64Image: string, reason: string): Promise<VisualDiagnostic> => {
    try {
      ...
      return {
        ...
        aiAnalysis: 'Falla en nodo visual.',
      };
    }
  },
